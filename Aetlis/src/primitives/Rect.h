...
struct CircleBorder {
	...
	CircleBorder() : center(0, 0), radius(0) {};
	CircleBorder(Point c, float r) : center(c), radius(r) {};
	CircleBorder(float x, float y, float r) : center(x, y), radius(r) {};

	float getX() { return center.getX(); };
	float getY() { return center.getY(); };
