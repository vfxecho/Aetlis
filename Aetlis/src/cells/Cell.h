...
// Linelock and cell update flags
const unsigned char LOCK_BIT = 0x01;
const unsigned char UPDATE_BIT = 0x02; // As seen in example, might be useful
...
public:
	...
	unsigned char cellFlags = 0; // Added for linelock and other states
